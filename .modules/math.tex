% Packages `amsmath`, `amsthm`, and `mathtools` are already loaded in
% `load-first.tex`.

% Patch commands to make them more compatible with LuaTeX
\ifluatex
...
% Allow aligning `\underbrace` and `\overbrace`
