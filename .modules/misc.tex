...
\@ifclassloaded{article}{
    \usepackage[b5paper, scale=0.725]{geometry}
    % Slightly larger text area than default (0.7).
}

% Line spacing
\usepackage{setspace}
\setstretch{1.2}
% Slightly smaller than one-half spacing (1.25 for 12pt).
...
% Page-based numbering, enable with `\usePerpageNumbering`
\newcommand{\usePerpageNumbering}{
