...
% -----------------------------------------------------------------------------
% Package `physics` will be dropped in the future.

\usepackage{physics}

% \providecommand{\qq}{}
% \renewcommand{\qq}[1]{\quad{#1}\quad}

% \providecommand{\abs}{}
% \renewcommand{\abs}[1]{\left\lvert{#1}\right\rvert}

% \WithSuffix\providecommand{\abs*}{}
% \WithSuffix\renewcommand{\abs*}[1]{\lvert{#1}\rvert}

% TODO: implement `\dv` and `\pdv`
% TODO: update MathJax
