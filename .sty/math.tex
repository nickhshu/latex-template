...
% main problem is that font commands in `unicode-math` do not nest. The
% following is a workaround. Use `\mm` and `\vv` for bold italic letters, and
% `\mm*` and `\vv*` for bold upright letters.
